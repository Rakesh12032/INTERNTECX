...
const responses = [
  { keys: ["suggest course", "course"], reply: "Tell us your interest area like web, python, AI/ML, design, cloud, data science, cybersecurity, or Android and Interntex AI will suggest the best path." },
  ...
  { keys: ["verify"], reply: "You can verify any Interntex certificate from the Verify page using the certificate ID. Colleges can use the College Verify portal too." },
  ...
  { keys: ["internship"], reply: "Interntex internship tracks include web dev, AI/ML, data science, cybersecurity, UI/UX, python, cloud, and Android/iOS." },
  ...
  { keys: ["free"], reply: "Many seeded courses are free in the current Interntex build. Some advanced tracks and internships are paid." },
  ...
  { keys: ["placement"], reply: "Interntex is designed to move students from learning to internships to verified certificates and finally toward jobs." },
